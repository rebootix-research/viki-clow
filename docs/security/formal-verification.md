...
summary: Machine-checked security models for VikiClow’s highest-risk paths.
read_when:
...
This page tracks VikiClow’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that VikiClow enforces its
...
**What this is not (yet):** a proof that “VikiClow is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/vikiclow-formal-models](https://github.com/vignesh07/vikiclow-formal-models).
...
```bash
git clone https://github.com/vignesh07/vikiclow-formal-models
cd vikiclow-formal-models
