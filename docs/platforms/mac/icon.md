---
summary: "Menu bar icon states and animations for VikiClow on macOS"
read_when:
...
- Base icon drawn in `VikiMarkRenderer.makeIcon(blink:legWiggle:earWiggle:earScale:earHoles:)`.
...
- Scurry uses leg wiggle up to ~1.0 with a small horizontal jiggle; it is additive to any existing idle wiggle.
