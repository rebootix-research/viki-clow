...
This is ideal for workflow engines like Viki Workflow: you can add a single LLM step
without writing custom VikiClow code for each workflow.
...
## Example: Viki Workflow workflow step
