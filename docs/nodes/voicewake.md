...
VikiClow treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.vikiclow/settings/voicewake.json`

Shape:

```json
{ "triggers": ["vikiclow", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
