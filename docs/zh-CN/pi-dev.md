...
本指南总结了在 VikiClow 中开发 Pi 集成的合理工作流程。
...
状态存储在 VikiClow 状态目录下。默认为 `~/.vikiclow`。如果设置了 `VIKICLOW_STATE_DIR`，则使用该目录。
...
- https://docs.vikiclow.ai/testing
- https://docs.vikiclow.ai/start/getting-started
