...
summary: "`vikiclow skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- VikiClow Skills Registry 安装：[VikiClow Skills Registry](/tools/vikiclow-skills)

## 命令

```bash
vikiclow skills list
vikiclow skills list --eligible
vikiclow skills info <name>
vikiclow skills check
```
