---
summary: "Overview of VikiClow onboarding options and flows"
read_when:
...
VikiClow supports multiple onboarding paths depending on where the Gateway runs
...
- [`vikiclow onboard` command](/cli/onboard)

## macOS app onboarding

Use the VikiClow app when you want a fully guided setup on macOS. Docs:
