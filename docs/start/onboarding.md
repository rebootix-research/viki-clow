---
summary: "First-run onboarding flow for VikiClow (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give VikiClow">
...
<Step title="CLI">
  ...
  The app can install the global `vikiclow` CLI via npm/pnpm so terminal
