...
read_when:
  ...
  - Wiring external systems into VikiClow
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your VikiClow config directory (typically `~/.vikiclow/hooks/transforms`).
...
- `vikiclow webhooks gmail setup` writes `hooks.gmail` config for `vikiclow webhooks gmail run`.
