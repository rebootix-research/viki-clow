...
read_when:
  - You want VikiClow to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables VikiClow to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`vikiclow onboard`) and `vikiclow channels add` list optional channel plugins.
...
```bash
vikiclow plugins install @vikiclow/nostr
```

Use a local checkout (dev workflows):

```bash
vikiclow plugins install --link <path-to-vikiclow>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "vikiclow",
        "displayName": "VikiClow",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "vikiclow@example.com",
        "lud16": "vikiclow@example.com"
      }
    }
  }
}
