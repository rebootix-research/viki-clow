...
- Install via CLI: `vikiclow plugins install @vikiclow/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `vikiclow plugins install ./extensions/zalo`
   - From npm (if published): `vikiclow plugins install @vikiclow/zalo`
...
- Approve via:
  - `vikiclow pairing list zalo`
  - `vikiclow pairing approve zalo <CODE>`
...
- Example: `vikiclow message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `vikiclow channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `vikiclow logs --follow`
