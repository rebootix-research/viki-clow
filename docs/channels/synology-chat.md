---
summary: "Synology Chat webhook setup and VikiClow config"
read_when:
  - Setting up Synology Chat with VikiClow
...
```bash
vikiclow plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your VikiClow gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in VikiClow.
...
- Pairing approvals work with:
  - `vikiclow pairing list synology-chat`
  - `vikiclow pairing approve synology-chat <CODE>`
...
```bash
vikiclow message send --channel synology-chat --target 123456 --text "Hello from VikiClow"
vikiclow message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
