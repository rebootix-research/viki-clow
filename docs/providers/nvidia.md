---
summary: "Use NVIDIA's OpenAI-compatible API in VikiClow"
read_when:
  - You want to use NVIDIA models in VikiClow
...
vikiclow onboard --auth-choice skip
vikiclow models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
