...
You can point VikiClow at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or VikiClow
...
- [Anthropic provider](/providers/anthropic) - Native VikiClow integration with Claude setup-token or API keys
