---
summary: "Use Qianfan's unified API to access many models in VikiClow"
read_when:
...
3. VikiClow installed on your system
...
4. Copy the API key for use with VikiClow

## CLI setup

```bash
vikiclow onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [VikiClow Configuration](/gateway/configuration)
