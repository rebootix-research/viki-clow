---
summary: "Use Qwen OAuth (free tier) in VikiClow"
read_when:
  - You want to use Qwen with VikiClow
...
If you already logged in with the Qwen Code CLI, VikiClow will sync credentials
