---
summary: "Use Kilo Gateway's unified API to access many models in VikiClow"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in VikiClow
---
...
```bash
vikiclow onboard --kilocode-api-key <key>
```
...
VikiClow dynamically discovers available models from the Kilo Gateway at startup. Use
