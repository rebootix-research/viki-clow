---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with VikiClow"
read_when:
  - You want Xiaomi MiMo models in VikiClow
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). VikiClow uses
