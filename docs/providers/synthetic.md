---
summary: "Use Synthetic's Anthropic-compatible API in VikiClow"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. VikiClow registers it as the
...
Note: VikiClow's Anthropic client appends `/v1` to the base URL, so use
