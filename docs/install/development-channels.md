...
VikiClow ships three update channels:
...
When you **explicitly** switch channels with `--channel`, VikiClow also aligns
the install method:
...
When you switch channels with `vikiclow update`, VikiClow also syncs plugin sources:
