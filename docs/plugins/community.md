...
read_when:
  - You want to publish a third-party VikiClow plugin
...
This page tracks high-quality **community-maintained plugins** for VikiClow.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `vikiclow plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `vikiclow plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect VikiClow to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/vikiclow-wechat`
  repo: `https://github.com/icesword0760/vikiclow-wechat`
  install: `vikiclow plugins install @icesword760/vikiclow-wechat`
