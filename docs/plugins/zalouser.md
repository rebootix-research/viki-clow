...
read_when:
  - You want Zalo Personal (unofficial) support in VikiClow
...
Zalo Personal support for VikiClow via a plugin, using native `zca-js` to automate a normal Zalo user account.
