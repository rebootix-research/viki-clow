...
read_when:
  - You are building a VikiClow plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (vikiclow.plugin.json)

Every plugin **must** ship a `vikiclow.plugin.json` file in the **plugin root**.
VikiClow uses this manifest to validate configuration **without executing plugin
