import type { VikiClowConfig, VikiClowPluginApi } from "vikiclow/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: VikiClowConfig): { id: string; name: string } {
