...
import type { ReplyPayload, VikiClowConfig } from "vikiclow/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "vikiclow/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as VikiClowConfig;
