import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "vikiclow/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: VikiClowConfig, dmPolicy: DmPolicy): VikiClowConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your VikiClow gateway URL + webhook path",
