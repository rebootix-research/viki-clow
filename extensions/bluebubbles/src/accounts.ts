...
import { createAccountListHelpers, type VikiClowConfig } from "vikiclow/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: VikiClowConfig): ResolvedBlueBubblesAccount[] {
