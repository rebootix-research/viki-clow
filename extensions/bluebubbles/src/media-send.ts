...
import { resolveChannelMediaMaxBytes, type VikiClowConfig } from "vikiclow/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: VikiClowConfig; accountId?: string }): string[] {
