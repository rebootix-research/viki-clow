...
This directory contains the **BlueBubbles external channel plugin** for VikiClow.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `vikiclow/plugin-sdk` helpers.
