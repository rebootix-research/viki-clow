import type {
  ...
  PluginLogger,
} from "vikiclow/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "vikiclow/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: VikiClowPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: VikiClowPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
