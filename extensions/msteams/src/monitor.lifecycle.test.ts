...
import type { VikiClowConfig, RuntimeEnv } from "vikiclow/plugin-sdk/msteams";
...
vi.mock("vikiclow/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): VikiClowConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
