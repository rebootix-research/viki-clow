import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "vikiclow/plugin-sdk/msteams";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setMSTeamsDmPolicy(cfg: VikiClowConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: VikiClowConfig, allowFrom: string[]): VikiClowConfig {
