...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "vikiclow/plugin-sdk/msteams";
...
import { resolvePreferredVikiClowTmpDir } from "../../../src/infra/tmp-vikiclow-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredVikiClowTmpDir(), "msteams-mention-"));
