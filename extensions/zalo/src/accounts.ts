...
import { createAccountListHelpers, type VikiClowConfig } from "vikiclow/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: VikiClowConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: VikiClowConfig): ResolvedZaloAccount[] {
