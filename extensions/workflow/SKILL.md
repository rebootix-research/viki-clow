...
Viki Workflow executes multi-step workflows with approval checkpoints. Use it when:
...
## When to use Viki Workflow

| User intent                                            | Use Viki Workflow?                            |
| ------------------------------------------------------ | --------------------------------------------- |
