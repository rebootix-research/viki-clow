...
import { fetchWithSsrFGuard } from "vikiclow/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to VikiClow workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".vikiclow", "workspace", "media", "inbound");
 ...
 * Format matches VikiClow's expected attachment structure.
 */
