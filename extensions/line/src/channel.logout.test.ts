import type { VikiClowConfig, PluginRuntime, ResolvedLineAccount } from "vikiclow/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: VikiClowConfig; accountId: string }): Promise<{
