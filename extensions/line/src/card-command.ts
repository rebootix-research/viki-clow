import type { LineChannelData, VikiClowPluginApi, ReplyPayload } from "vikiclow/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: VikiClowPluginApi): void {
  api.registerCommand({
    name: "card",
