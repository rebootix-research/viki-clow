...
import type { VikiClowPluginApi } from "vikiclow/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("vikiclow/plugin-sdk/mattermost").VikiClowConfig;
    runtime: import("vikiclow/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: VikiClowPluginApi) {
