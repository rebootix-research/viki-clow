...
import { createAccountListHelpers, type VikiClowConfig } from "vikiclow/plugin-sdk/mattermost";
...
export function listEnabledMattermostAccounts(cfg: VikiClowConfig): ResolvedMattermostAccount[] {
