import {
  ...
  type VikiClowConfig,
} from "vikiclow/plugin-sdk/mattermost";
export { createDedupeCache, rawDataToString } from "vikiclow/plugin-sdk/mattermost";
...
function listAgents(cfg: VikiClowConfig): AgentEntry[] {
...
export function resolveIdentityName(cfg: VikiClowConfig, agentId: string): string | undefined {
