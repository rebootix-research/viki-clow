...
import { createAccountListHelpers, type VikiClowConfig } from "vikiclow/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: VikiClowConfig, accountId: string): ZalouserAccountConfig {
