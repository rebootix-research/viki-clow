...
import { isSecretRef } from "vikiclow/plugin-sdk/googlechat";
import { createAccountListHelpers, type VikiClowConfig } from "vikiclow/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: VikiClowConfig): ResolvedGoogleChatAccount[] {
