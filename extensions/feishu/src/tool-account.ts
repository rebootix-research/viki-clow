...
import type { VikiClowPluginApi } from "vikiclow/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: VikiClowPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<VikiClowPluginApi, "config">;
