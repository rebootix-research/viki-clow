...
import { withTempDownloadPath, type VikiClowBotConfig } from "vikiclow/plugin-sdk/feishu";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "vikiclow-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "vikiclow-feishu-resource-",
