import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "vikiclow/plugin-sdk/account-id";
import type { VikiClowBotConfig } from "vikiclow/plugin-sdk/feishu";
 ...
 */
function listConfiguredAccountIds(cfg: VikiClowBotConfig): string[] {
 ...
 */
export function listFeishuAccountIds(cfg: VikiClowBotConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: VikiClowBotConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: VikiClowBotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: VikiClowBotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: VikiClowBotConfig): ResolvedFeishuAccount[] {
