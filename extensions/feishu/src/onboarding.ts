import type {
  ...
  SecretInput,
  WizardPrompter,
} from "vikiclow/plugin-sdk/feishu";
import {
...
function setFeishuDmPolicy(cfg: VikiClowBotConfig, dmPolicy: DmPolicy): VikiClowBotConfig {
...
function setFeishuAllowFrom(cfg: VikiClowBotConfig, allowFrom: string[]): VikiClowBotConfig {
