import type { VikiClowBotConfig, PluginRuntime, RuntimeEnv } from "vikiclow/plugin-sdk/feishu";
...
async function dispatchMessage(params: { cfg: VikiClowBotConfig; event: FeishuMessageEvent }) {
...
describe("broadcast dispatch", () => {
  ...
  it("dispatches to all broadcast agents when bot is mentioned", async () => {
    ...
    } as unknown as VikiClowBotConfig;
