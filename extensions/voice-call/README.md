...
Official Voice Call plugin for **VikiClow**.
...
Docs: `https://docs.vikiclow.ai/plugins/voice-call`
Plugin system: `https://docs.vikiclow.ai/plugin`

## Install (local dev)

### Option A: install via VikiClow (recommended)
...
```bash
mkdir -p ~/.vikiclow/extensions
cp -R extensions/voice-call ~/.vikiclow/extensions/voice-call
cd ~/.vikiclow/extensions/voice-call && pnpm install
```
...
```bash
vikiclow voicecall call --to "+15555550123" --message "Hello from VikiClow"
vikiclow voicecall continue --call-id <id> --message "Any questions?"
vikiclow voicecall speak --call-id <id> --message "One moment"
vikiclow voicecall end --call-id <id>
vikiclow voicecall status --call-id <id>
vikiclow voicecall tail
