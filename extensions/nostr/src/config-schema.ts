import { AllowFromListSchema, DmPolicySchema } from "vikiclow/plugin-sdk/compat";
import { MarkdownConfigSchema, buildChannelConfigSchema } from "vikiclow/plugin-sdk/nostr";
import { z } from "zod";
