...
} from "vikiclow/plugin-sdk/account-id";
import type { VikiClowConfig } from "vikiclow/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: VikiClowConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: VikiClowConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: VikiClowConfig): string {
