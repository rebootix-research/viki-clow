...
Nostr DM channel plugin for VikiClow using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to VikiClow. It enables your bot to:
...
# Configure vikiclow to use local relay
