...
const requiredPathGroups = [
  ...
  "dist/plugin-sdk/workflow.d.ts",
  "dist/plugin-sdk/workflow-runtime.js",
  "dist/plugin-sdk/workflow-runtime.d.ts",
  ...
  "dist/plugin-sdk/prose.js",
  "dist/plugin-sdk/prose.d.ts",
  ...
  "dist/docs/reference/templates/IDENTITY.md",
  "dist/docs/reference/templates/AGENTS.md",
  "dist/docs/reference/templates/SOUL.md",
  "dist/docs/reference/templates/TOOLS.md",
  "dist/docs/reference/templates/USER.md",
  "dist/docs/reference/templates/HEARTBEAT.md",
  "dist/docs/reference/templates/BOOTSTRAP.md",
...
export function collectBundledExtensionRootDependencyGapErrors(params: {
  ...
  for (const extension of normalizeBundledExtensionMetadata(params.extensions)) {
    ...
    const missing = Object.keys(extension.packageJson.dependencies ?? {})
      .filter((dep) => dep !== "vikiclow" && !rootDeps[dep])
      .toSorted();
...
// Critical functions that channel extension plugins import from vikiclow/plugin-sdk.
