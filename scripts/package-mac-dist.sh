...
# Output:
# - dist/VikiClow.app
# - dist/VikiClow-<version>.zip
# - dist/VikiClow-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.vikiclow.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/VikiClow.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/VikiClow-$VERSION.zip"
DMG="$ROOT_DIR/dist/VikiClow-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/VikiClow-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/VikiClow-$VERSION.dSYM.zip"
