...
show_usage() {
    cat << EOF
clawlog - VikiClow Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View VikiClow logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    VikiClow logs flow through the macOS unified log (subsystem: ai.vikiclow).
