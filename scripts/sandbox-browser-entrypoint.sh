...
export DISPLAY=:1
export HOME=/tmp/vikiclow-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${VIKICLOW_BROWSER_CDP_PORT:-${VIKICLOWBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${VIKICLOW_BROWSER_CDP_SOURCE_RANGE:-${VIKICLOWBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${VIKICLOW_BROWSER_VNC_PORT:-${VIKICLOWBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${VIKICLOW_BROWSER_NOVNC_PORT:-${VIKICLOWBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${VIKICLOW_BROWSER_ENABLE_NOVNC:-${VIKICLOWBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${VIKICLOW_BROWSER_HEADLESS:-${VIKICLOWBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${VIKICLOW_BROWSER_NO_SANDBOX:-${VIKICLOWBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${VIKICLOW_BROWSER_NOVNC_PASSWORD:-${VIKICLOWBOT_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${VIKICLOW_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${VIKICLOW_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${VIKICLOW_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
