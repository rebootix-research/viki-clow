...
FEED_URL=${2:-"https://raw.githubusercontent.com/vikiclow/vikiclow/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/vikiclow/vikiclow/releases/download/v${VERSION}/"}
