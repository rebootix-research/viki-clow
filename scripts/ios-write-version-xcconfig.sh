...
- VIKICLOW_GATEWAY_VERSION = exact package.json version
- VIKICLOW_MARKETING_VERSION = short iOS/App Store version
- VIKICLOW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
VIKICLOW_GATEWAY_VERSION = ${PACKAGE_VERSION}
VIKICLOW_MARKETING_VERSION = ${MARKETING_VERSION}
VIKICLOW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
