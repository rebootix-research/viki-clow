...
- Keep product names in English: VikiClow, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the VikiClow Gateway, use “Gateway 网关”.
