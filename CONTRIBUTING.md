...
Welcome to the VikiClow contributor hub.

## Quick Links

- **GitHub:** https://github.com/rebootix-research/viki-clow
...
2. **New features / architecture** -> Start a [GitHub Discussion](https://github.com/rebootix-research/viki-clow/discussions) or ask in Discord first.
...
- **Skills**: For skill contributions, head to [VikiClow Skills Registry](https://vikiclow-skills.ai/) - the community hub for VikiClow skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/rebootix-research/viki-clow/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape VikiClow's direction - whether through code, docs, or community - we'd like to hear from you.
