...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.vikiclow/vikiclow.json`
...
- The script prints a `MEDIA:` line for VikiClow to auto-attach on supported chat providers.
