...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof VikiClowConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: VikiClowConfig; env: NodeJS.ProcessEnv }): {
  cfg: VikiClowConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
