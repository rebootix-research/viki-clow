...
const coreEntries: CoreCliEntry[] = [
  ...
  },
  {
    commands: [
      {
        name: "backup",
        description: "Create and verify local backup archives for VikiClow state",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      {
        name: "capabilities",
        description: "Inspect and provision runtime capabilities",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("../mission-cli.js");
      mod.registerMissionCli(program);
    },
  },
  {
    commands: [
  ...
  },
  {
    commands: [
      {
        name: "browser",
        description: "Manage VikiClow's dedicated browser (Chrome/Chromium)",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      {
        name: "evolution",
        description: "Manage candidate intake, experiments, and promotion records",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
      const mod = await import("../evolution-cli.js");
      mod.registerEvolutionCli(program);
    },
  },
];
