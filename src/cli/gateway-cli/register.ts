      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["vikiclow gateway run", "Run the gateway in the foreground."],
            ["vikiclow gateway status", "Show service status and probe reachability."],
            ["vikiclow gateway discover", "Find local and wide-area gateway beacons."],
            ["vikiclow gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.vikiclow.ai/cli/gateway")}\n`,
      ),
  );
