    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["vikiclow channels list", "List configured channels and auth profiles."],
          ["vikiclow channels status --probe", "Run channel status checks and probes."],
          [
            "vikiclow channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["vikiclow channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.vikiclow.ai/cli/channels",
        )}\n`,
    );
