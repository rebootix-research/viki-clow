const DEFAULT_TAGLINE = "Autonomous work, shipped with VikiClow.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho - VikiClow is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just gained a serious execution partner.",
  ...
  "If it works, we ship it; if it breaks, we fix it fast.",
  ...
  "Automation with intent: minimal fuss, maximal follow-through.",
  ...
  "Focus on the outcome - VikiClow will handle the repetition.",
  "A sharper workflow without the extra ceremony.",
  "Shell yes - less toil, more momentum.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The agent in your workspace that actually finishes the task.",
  ...
  "Built to execute, adapt, and keep moving.",
  ...
  "Built for operators who want progress, not excuses.",
  ...
  "Open source, operator-first, and ready to work.",
  ...
  "You had me at 'vikiclow gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.VIKICLOW_TAGLINE_INDEX;
