...
const SANDBOX_EXAMPLES = {
  main: [
    ["vikiclow sandbox list", "List all sandbox containers."],
    ["vikiclow sandbox list --browser", "List only browser containers."],
    ["vikiclow sandbox recreate --all", "Recreate all containers."],
    ["vikiclow sandbox recreate --session main", "Recreate a specific session."],
    ["vikiclow sandbox recreate --agent mybot", "Recreate agent containers."],
    ["vikiclow sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["vikiclow sandbox list", "List all sandbox containers."],
    ["vikiclow sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["vikiclow sandbox recreate --all", "Recreate all containers."],
    ["vikiclow sandbox recreate --session main", "Recreate a specific session."],
    ["vikiclow sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["vikiclow sandbox recreate --browser --all", "Recreate only browser containers."],
    ["vikiclow sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["vikiclow sandbox explain", "Show effective sandbox config."],
    ["vikiclow sandbox explain --session agent:main:main", "Explain a specific session."],
    ["vikiclow sandbox explain --agent work", "Explain an agent sandbox."],
    ["vikiclow sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.vikiclow.ai/cli/sandbox")}\n`,
    )
    .action(() => {
