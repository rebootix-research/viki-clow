    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["vikiclow directory self --channel slack", "Show the connected account identity."],
          [
            'vikiclow directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["vikiclow directory groups list --channel discord", "List available groups/channels."],
          [
            "vikiclow directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.vikiclow.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
