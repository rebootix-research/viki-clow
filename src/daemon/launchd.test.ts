...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.vikiclow.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", VIKICLOW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.vikiclow.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.vikiclow.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when VIKICLOW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.vikiclow.gateway.plist",
    },
    {
      name: "uses profile-specific label when VIKICLOW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", VIKICLOW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.vikiclow.jbphoenix.plist",
    },
    {
      name: "prefers VIKICLOW_LAUNCHD_LABEL over VIKICLOW_PROFILE",
      env: {
        HOME: "/Users/test",
        VIKICLOW_PROFILE: "jbphoenix",
        VIKICLOW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from VIKICLOW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        VIKICLOW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty VIKICLOW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        VIKICLOW_PROFILE: "myprofile",
        VIKICLOW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.vikiclow.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
