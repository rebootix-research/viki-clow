...
describe("gateway auth", () => {
  ...
  it("resolves token/password from VIKICLOW gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          VIKICLOW_GATEWAY_TOKEN: "env-token",
          VIKICLOW_GATEWAY_PASSWORD: "env-password",
  ...
  it("does not resolve legacy VIKICLOWBOT gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          VIKICLOWBOT_GATEWAY_TOKEN: "legacy-token",
          VIKICLOWBOT_GATEWAY_PASSWORD: "legacy-password",
        } as NodeJS.ProcessEnv,
      }),
    ).toMatchObject({
      mode: "token",
  ...
  it("accepts password mode when env provides VIKICLOW_GATEWAY_PASSWORD", () => {
