...
export function hasAmbiguousGatewayAuthModeConfig(cfg: VikiClowConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: VikiClowConfig): void {
