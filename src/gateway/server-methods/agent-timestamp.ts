 ...
 *
 * @see legacy upstream issue 3658 for the timestamp recovery constraints.
 */
...
/**
 * Build TimestampInjectionOptions from an VikiClowConfig.
 */
export function timestampOptsFromConfig(cfg: VikiClowConfig): TimestampInjectionOptions {
  return {
