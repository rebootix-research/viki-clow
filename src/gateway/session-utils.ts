...
import { type VikiClowConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: VikiClowConfig): string[] {
...
export function listAgentsForGateway(cfg: VikiClowConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: VikiClowConfig): string {
...
function resolveSessionStoreAgentId(cfg: VikiClowConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: VikiClowConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: VikiClowConfig): GatewaySessionsDefaults {
