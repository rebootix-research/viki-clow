...
describe("agent components", () => {
  const createCfg = (): VikiClowConfig => ({}) as VikiClowConfig;
...
describe("discord component interactions", () => {
  const createCfg = (): VikiClowConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/vikiclow-sessions-test.json");
  });
