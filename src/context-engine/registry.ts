...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("vikiclow.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: VikiClowConfig): Promise<ContextEngine> {
