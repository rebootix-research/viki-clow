...
function mergeSignalAccountConfig(cfg: VikiClowConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: VikiClowConfig): ResolvedSignalAccount[] {
