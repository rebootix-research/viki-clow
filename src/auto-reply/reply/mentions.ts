...
function resolveMentionPatterns(cfg: VikiClowConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: VikiClowConfig | undefined, agentId?: string): RegExp[] {
