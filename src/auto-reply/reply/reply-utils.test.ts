...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bvikiclow\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "VikiClow",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[VikiClow] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
