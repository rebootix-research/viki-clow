...
function resolveAcpStreamCoalesceIdleMs(cfg: VikiClowConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: VikiClowConfig): number {
...
export function resolveAcpProjectionSettings(cfg: VikiClowConfig): AcpProjectionSettings {
