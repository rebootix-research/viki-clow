...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@vikiclow", { botUsername: "vikiclow" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@vikiclow args", {
        botUsername: "vikiclow",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@vikiclow: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "vikiclow" })).toBe(
      "/help@otherbot",
    );
  });
