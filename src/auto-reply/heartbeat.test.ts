...
describe("isHeartbeatContentEffectivelyEmpty", () => {
  ...
  it("treats blank checklist placeholders as effectively empty", () => {
    expect(isHeartbeatContentEffectivelyEmpty("- [ ]")).toBe(true);
    expect(isHeartbeatContentEffectivelyEmpty("# HEARTBEAT.md\n\n## Focus\n- [ ]")).toBe(true);
  });

  it("returns true for default template content (comments + blank checklist)", () => {
    const defaultTemplate = `# HEARTBEAT.md

# Keep this file comment-only to skip heartbeat API calls.
## Focus
- [ ]
`;
