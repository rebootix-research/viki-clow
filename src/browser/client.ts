...
export async function browserDaemonStatus(baseUrl?: string): Promise<BrowserdManifest> {
  return await fetchBrowserJson<BrowserdManifest>(withBaseUrl(baseUrl, `/browserd`), {
    timeoutMs: 3000,
  });
}
