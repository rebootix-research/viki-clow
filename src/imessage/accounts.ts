...
function mergeIMessageAccountConfig(cfg: VikiClowConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: VikiClowConfig): ResolvedIMessageAccount[] {
