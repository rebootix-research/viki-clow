...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: VikiClowConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: VikiClowConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: VikiClowConfig) => string;
  setAccountEnabled?: (params: {
    cfg: VikiClowConfig;
    accountId: string;
    enabled: boolean;
  }) => VikiClowConfig;
  deleteAccount?: (params: { cfg: VikiClowConfig; accountId: string }) => VikiClowConfig;
  isEnabled?: (account: ResolvedAccount, cfg: VikiClowConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: VikiClowConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: VikiClowConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: VikiClowConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: VikiClowConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.vikiclow.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: VikiClowConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
