...
import { discoverVikiClowPlugins } from "../../plugins/discovery.js";
import type { VikiClowPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, VikiClowPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["VIKICLOW_PLUGIN_CATALOG_PATHS", "VIKICLOW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<VikiClowPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: VikiClowPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: VikiClowPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverVikiClowPlugins({ workspaceDir: options.workspaceDir });
