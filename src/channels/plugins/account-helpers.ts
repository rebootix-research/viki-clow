...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: VikiClowConfig): string | undefined {
  ...
  function listAccountIds(cfg: VikiClowConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: VikiClowConfig): string {
