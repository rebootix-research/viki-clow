...
export function listChannelMessageActions(cfg: VikiClowConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: VikiClowConfig): boolean {
...
export function supportsChannelMessageCards(cfg: VikiClowConfig): boolean {
