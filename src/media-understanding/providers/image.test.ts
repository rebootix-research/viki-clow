...
const ensureVikiClowModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureVikiClowModelsJson: ensureVikiClowModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureVikiClowModelsJsonMock).toHaveBeenCalled();
