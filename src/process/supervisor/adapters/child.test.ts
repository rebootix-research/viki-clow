...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.VIKICLOW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.VIKICLOW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.VIKICLOW_SERVICE_MARKER = originalServiceMarker;
    }
  });
