...
// Prefix for VikiClow-generated action IDs to scope our handler
const VIKICLOW_ACTION_PREFIX = "vikiclow:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${VIKICLOW_ACTION_PREFIX}`);

  // Handle VikiClow modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
