/**
 * Hook system for VikiClow agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __vikiclow_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__vikiclow_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
