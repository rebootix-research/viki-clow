...
export const PLUGIN_MANIFEST_FILENAME = "vikiclow.plugin.json";
...
// package.json "vikiclow" metadata (used for onboarding/catalog)
...
export type VikiClowPackageManifest = {
  extensions?: string[];
...
): VikiClowPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
