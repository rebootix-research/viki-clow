...
const loadVikiClowPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadVikiClowPlugins: (params: unknown) => loadVikiClowPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadVikiClowPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadVikiClowPluginsMock.mockClear();
  });
