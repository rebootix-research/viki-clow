...
export type VikiClowPluginConfigSchema = {
...
export type VikiClowPluginToolContext = {
...
export type VikiClowPluginToolFactory = (
  ctx: VikiClowPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type VikiClowPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type VikiClowPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<VikiClowConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type VikiClowPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current VikiClow configuration */
  config: VikiClowConfig;
 ...
 */
export type VikiClowPluginCommandDefinition = {
...
export type VikiClowPluginHttpRouteAuth = "gateway" | "plugin";
export type VikiClowPluginHttpRouteMatch = "exact" | "prefix";

export type VikiClowPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type VikiClowPluginHttpRouteParams = {
  path: string;
  handler: VikiClowPluginHttpRouteHandler;
  auth: VikiClowPluginHttpRouteAuth;
  match?: VikiClowPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type VikiClowPluginCliContext = {
  program: Command;
  config: VikiClowConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type VikiClowPluginCliRegistrar = (ctx: VikiClowPluginCliContext) => void | Promise<void>;

export type VikiClowPluginServiceContext = {
  config: VikiClowConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type VikiClowPluginService = {
  id: string;
  start: (ctx: VikiClowPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: VikiClowPluginServiceContext) => void | Promise<void>;
};

export type VikiClowPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type VikiClowPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: VikiClowPluginConfigSchema;
  register?: (api: VikiClowPluginApi) => void | Promise<void>;
  activate?: (api: VikiClowPluginApi) => void | Promise<void>;
};

export type VikiClowPluginModule =
  | VikiClowPluginDefinition
  | ((api: VikiClowPluginApi) => void | Promise<void>);

export type VikiClowPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | VikiClowPluginToolFactory,
    opts?: VikiClowPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: VikiClowPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: VikiClowPluginHttpRouteParams) => void;
  registerChannel: (registration: VikiClowPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: VikiClowPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: VikiClowPluginService) => void;
   ...
   */
  registerCommand: (command: VikiClowPluginCommandDefinition) => void;
