...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/vikiclow/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/vikiclow/extensions",
        global: "/Users/x/.vikiclow/extensions",
        workspace: "/Users/x/ws/.vikiclow/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.vikiclow/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/vikiclow/extensions",
        global: "/Users/x/.vikiclow/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.vikiclow/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/vikiclow/extensions",
        global: "/Users/x/.vikiclow/extensions",
