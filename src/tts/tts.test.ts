...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.VIKICLOW_TTS_PREFS;
      process.env.VIKICLOW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.VIKICLOW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: VikiClowConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
