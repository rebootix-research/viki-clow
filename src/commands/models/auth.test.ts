...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: VikiClowConfig;
  let lastUpdatedConfig: VikiClowConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/vikiclow/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/vikiclow/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/vikiclow/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: VikiClowConfig) => VikiClowConfig) => {
