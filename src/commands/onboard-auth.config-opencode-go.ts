...
export function applyOpencodeGoProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyOpencodeGoConfig(cfg: VikiClowConfig): VikiClowConfig {
