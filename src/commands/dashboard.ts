...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set VIKICLOW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `vikiclow dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control VikiClow.");
  } else if (hint) {
    runtime.log(hint);
  }
}
