...
function resolveDefaultAccountId(cfg: VikiClowConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: VikiClowConfig): boolean {
...
export function summarizeBindings(cfg: VikiClowConfig, bindings: AgentBinding[]): string[] {
