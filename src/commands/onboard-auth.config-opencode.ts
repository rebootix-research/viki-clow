...
export function applyOpencodeZenProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyOpencodeZenConfig(cfg: VikiClowConfig): VikiClowConfig {
