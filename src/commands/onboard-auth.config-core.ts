...
export function applyOpenrouterProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyMoonshotConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: VikiClowConfig): VikiClowConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: VikiClowConfig): VikiClowConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: VikiClowConfig): VikiClowConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: VikiClowConfig): VikiClowConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyQianfanProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyModelStudioProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_GLOBAL_BASE_URL);
}

export function applyModelStudioProviderConfigCn(cfg: VikiClowConfig): VikiClowConfig {
  return applyModelStudioProviderConfigWithBaseUrl(cfg, MODELSTUDIO_CN_BASE_URL);
}

export function applyModelStudioConfig(cfg: VikiClowConfig): VikiClowConfig {
  const next = applyModelStudioProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MODELSTUDIO_DEFAULT_MODEL_REF);
}

export function applyModelStudioConfigCn(cfg: VikiClowConfig): VikiClowConfig {
