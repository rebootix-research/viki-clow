...
export function applyVercelAiGatewayProviderConfig(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyVercelAiGatewayConfig(cfg: VikiClowConfig): VikiClowConfig {
