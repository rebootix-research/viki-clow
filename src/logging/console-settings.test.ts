...
let originalVikiClowTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalVikiClowTestConsole = process.env.VIKICLOW_TEST_CONSOLE;
  process.env.VIKICLOW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalVikiClowTestConsole === undefined) {
    delete process.env.VIKICLOW_TEST_CONSOLE;
  } else {
    process.env.VIKICLOW_TEST_CONSOLE = originalVikiClowTestConsole;
  }
