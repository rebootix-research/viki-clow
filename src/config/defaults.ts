...
function resolveAnthropicDefaultAuthMode(cfg: VikiClowConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyTalkApiKey(config: VikiClowConfig): VikiClowConfig {
...
export function applyTalkConfigNormalization(config: VikiClowConfig): VikiClowConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: VikiClowConfig): VikiClowConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyLoggingDefaults(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyContextPruningDefaults(cfg: VikiClowConfig): VikiClowConfig {
...
export function applyCompactionDefaults(cfg: VikiClowConfig): VikiClowConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
