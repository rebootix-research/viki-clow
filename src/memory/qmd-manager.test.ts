...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: VikiClowConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: VikiClowConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__vikiclowMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__vikiclowMcporterColdStartWarned;
  });
