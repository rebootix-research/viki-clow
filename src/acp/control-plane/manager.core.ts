...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: VikiClowConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: VikiClowConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: VikiClowConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: VikiClowConfig }): Promise<void> {
