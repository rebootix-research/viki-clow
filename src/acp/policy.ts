...
export function isAcpEnabledByPolicy(cfg: VikiClowConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: VikiClowConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: VikiClowConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: VikiClowConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: VikiClowConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: VikiClowConfig, agentId: string): boolean {
