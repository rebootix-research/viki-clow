...
export function listBindings(cfg: VikiClowConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: VikiClowConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: VikiClowConfig) {
