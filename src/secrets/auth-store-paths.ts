...
export function listAuthProfileStorePaths(config: VikiClowConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: VikiClowConfig, stateDir: string): string[] {
