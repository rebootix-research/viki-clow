...
function resolveResolutionLimits(config: VikiClowConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: VikiClowConfig): SecretProviderConfig {
