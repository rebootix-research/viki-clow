...
async function runRuntimeWebTools(params: { config: VikiClowConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: VikiClowConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
