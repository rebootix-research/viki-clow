...
export function listWhatsAppAuthDirs(cfg: VikiClowConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: VikiClowConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: VikiClowConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: VikiClowConfig): ResolvedWhatsAppAccount[] {
