...
export const A2UI_PATH = "/__vikiclow__/a2ui";

export const CANVAS_HOST_PATH = "/__vikiclow__/canvas";

export const CANVAS_WS_PATH = "/__vikiclow__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.vikiclowCanvasA2UIAction.postMessage(...)
  // - Android: window.vikiclowCanvasA2UIAction.postMessage(...)
  const handlerNames = ["vikiclowCanvasA2UIAction"];
  ...
  globalThis.VikiClow = globalThis.VikiClow ?? {};
  globalThis.VikiClow.postMessage = postToNode;
  globalThis.VikiClow.sendUserAction = sendUserAction;
  globalThis.vikiclowPostMessage = postToNode;
  globalThis.vikiclowSendUserAction = sendUserAction;
