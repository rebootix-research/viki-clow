...
const CLEANUP_STATE_KEY = Symbol.for("vikiclow.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("vikiclow.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("vikiclow.sessionWriteLockWatchdogState");
