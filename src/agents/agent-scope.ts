...
type AgentEntry = NonNullable<NonNullable<VikiClowConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: VikiClowConfig): AgentEntry[] {
...
export function listAgentIds(cfg: VikiClowConfig): string[] {
...
export function resolveDefaultAgentId(cfg: VikiClowConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: VikiClowConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: VikiClowConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: VikiClowConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: VikiClowConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
