...
type ModelsConfig = NonNullable<VikiClowConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier VikiClow docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // VikiClow keeps auth in auth-profiles and resolves runtime availability from that store.
