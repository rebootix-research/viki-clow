...
import { createVikiClowCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
    ...
    try {
      ...
      try {
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("vikiclow:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
