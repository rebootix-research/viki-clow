...
function resolveAdaptiveReadMaxBytes(options?: VikiClowReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createVikiClowReadTool(base, {
...
export function createVikiClowReadTool(
  base: AnyAgentTool,
  options?: VikiClowReadToolOptions,
): AnyAgentTool {
