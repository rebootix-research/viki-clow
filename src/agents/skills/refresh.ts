...
function resolveWatchPaths(workspaceDir: string, config?: VikiClowConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: VikiClowConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: VikiClowConfig }) {
