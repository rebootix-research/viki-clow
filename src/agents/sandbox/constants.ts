...
export const DEFAULT_SANDBOX_IMAGE = "vikiclow-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "vikiclow-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "vikiclow-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "vikiclow-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "vikiclow-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "vikiclow-sandbox-browser";
