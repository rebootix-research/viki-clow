...
async function resolveContext(config: VikiClowConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): VikiClowConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
