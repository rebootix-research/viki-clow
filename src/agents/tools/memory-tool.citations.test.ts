...
function asVikiClowConfig(config: Partial<VikiClowConfig>): VikiClowConfig {
  return config as VikiClowConfig;
}

function createToolConfig() {
  return asVikiClowConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: VikiClowConfig = createToolConfig()) {
