...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): VikiClowConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: VikiClowConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: VikiClowConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
