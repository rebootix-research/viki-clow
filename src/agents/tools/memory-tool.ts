...
function resolveMemoryToolContext(options: { config?: VikiClowConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: VikiClowConfig): MemoryCitationsMode {
