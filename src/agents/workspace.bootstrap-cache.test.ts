...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("vikiclow-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("vikiclow-cache-test1-");
    const workspace2 = await makeTempWorkspace("vikiclow-cache-test2-");
