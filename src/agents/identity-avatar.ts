...
function resolveAvatarSource(cfg: VikiClowConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: VikiClowConfig, agentId: string): AgentAvatarResolution {
