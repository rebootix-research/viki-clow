...
export function resolveSubagentToolPolicy(cfg?: VikiClowConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: VikiClowConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: VikiClowConfig["tools"];
