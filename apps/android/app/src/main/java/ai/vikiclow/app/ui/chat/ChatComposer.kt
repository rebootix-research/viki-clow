...
import ai.vikiclow.app.ui.mobileSurface
import ai.vikiclow.app.ui.mobileText
import ai.vikiclow.app.ui.mobileTextSecondary
import ai.vikiclow.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.vikiclow.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.vikiclow.app.ui.mobileFontFamily,
