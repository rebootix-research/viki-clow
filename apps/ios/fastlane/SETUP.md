...
ASC_KEYCHAIN_SERVICE=vikiclow-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.vikiclow.client
# or
...
- The beta flow regenerates `apps/ios/VikiClow.xcodeproj` from `apps/ios/project.yml` before archiving
