...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.vikiclow.ios", category: "LiveActivity")
    private var currentActivity: Activity<VikiClowActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = VikiClowActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<VikiClowActivityAttributes>.activities
    ...
    private func updateCurrent(state: VikiClowActivityAttributes.ContentState) {
    ...
    private func connectingState() -> VikiClowActivityAttributes.ContentState {
        VikiClowActivityAttributes.ContentState(
    ...
    private func idleState() -> VikiClowActivityAttributes.ContentState {
        VikiClowActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> VikiClowActivityAttributes.ContentState {
        VikiClowActivityAttributes.ContentState(
