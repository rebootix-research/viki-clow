...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: VikiClowPhotosLatestParams) async throws -> VikiClowPhotosLatestPayload {
        ...
        var results: [VikiClowPhotoPayload] = []
        ...
        return VikiClowPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> VikiClowPhotoPayload
    {
