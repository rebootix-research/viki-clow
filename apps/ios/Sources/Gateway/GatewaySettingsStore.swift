...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.vikiclow.gateway"
    private static let nodeService = "ai.vikiclow.node"
    private static let talkService = "ai.vikiclow.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.vikiclow.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.vikiclow.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("vikiclow-gateway.log")
    }
