...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = VikiClowLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = VikiClowLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.vikiclow.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your VikiClow agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected VikiClow agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while VikiClow is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for VikiClow. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(VikiClowLocationMode.off.rawValue)
                            Text("While Using").tag(VikiClowLocationMode.whileUsing.rawValue)
                            Text("Always").tag(VikiClowLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while VikiClow is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("VikiClow", value: DeviceInfoHelper.vikiclowVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = VikiClowLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your VikiClow chat and run /pair approve, then tap Connect again."
        }
