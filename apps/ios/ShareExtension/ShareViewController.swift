...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.vikiclow.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to VikiClow", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to VikiClow gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to VikiClow.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "VikiClowShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "VikiClow is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "VikiClow Share",
        ...
        try await gateway.connect(
            ...
            connectOptions: makeOptions("vikiclow-ios"),
            sessionBox: nil,
            onConnected: {},
            onDisconnected: { _ in },
            onInvoke: { req in
