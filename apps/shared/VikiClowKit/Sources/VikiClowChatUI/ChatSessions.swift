...
public struct VikiClowChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct VikiClowChatSessionsDefaults: Codable, Sendable {
    public let model: String?
    public let contextTokens: Int?
}

public struct VikiClowChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct VikiClowChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: VikiClowChatSessionsDefaults?
    public let sessions: [VikiClowChatSessionEntry]
}
