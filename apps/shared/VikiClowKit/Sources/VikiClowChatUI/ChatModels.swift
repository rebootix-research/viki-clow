...
public typealias VikiClowPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias VikiClowPlatformImage = UIImage
#endif

public struct VikiClowChatUsageCost: Codable, Hashable, Sendable {
...
public struct VikiClowChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: VikiClowChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(VikiClowChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct VikiClowChatMessageContent: Codable, Hashable, Sendable {
...
public struct VikiClowChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [VikiClowChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: VikiClowChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [VikiClowChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: VikiClowChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(VikiClowChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([VikiClowChatMessageContent].self, forKey: .content) {
...
public struct VikiClowChatHistoryPayload: Codable, Sendable {
...
public struct VikiClowSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct VikiClowSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [VikiClowSessionPreviewItem]
}

public struct VikiClowSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [VikiClowSessionPreviewEntry]

    public init(ts: Int, previews: [VikiClowSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct VikiClowChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct VikiClowChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct VikiClowAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct VikiClowChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct VikiClowGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct VikiClowPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: VikiClowPlatformImage?
...
public struct VikiClowChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
