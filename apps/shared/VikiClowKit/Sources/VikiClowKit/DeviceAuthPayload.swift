...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: VikiClowProtocol.AnyCodable]?
    {
        ...
        return [
            "id": VikiClowProtocol.AnyCodable(identity.deviceId),
            "publicKey": VikiClowProtocol.AnyCodable(publicKey),
            "signature": VikiClowProtocol.AnyCodable(signature),
            "signedAt": VikiClowProtocol.AnyCodable(signedAtMs),
            "nonce": VikiClowProtocol.AnyCodable(nonce),
        ]
    }
}
