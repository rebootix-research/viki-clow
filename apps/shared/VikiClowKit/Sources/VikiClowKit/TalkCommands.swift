...
public enum VikiClowTalkCommand: String, Codable, Sendable {
...
public struct VikiClowTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct VikiClowTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
