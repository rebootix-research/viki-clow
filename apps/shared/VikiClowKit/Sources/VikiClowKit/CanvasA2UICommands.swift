...
public enum VikiClowCanvasA2UICommand: String, Codable, Sendable {
...
public struct VikiClowCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct VikiClowCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
