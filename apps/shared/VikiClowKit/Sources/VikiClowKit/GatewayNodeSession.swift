...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.vikiclow", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.vikiclow", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: VikiClowProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
