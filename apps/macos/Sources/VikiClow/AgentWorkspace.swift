...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.vikiclow", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return VikiClowConfigFile.defaultWorkspaceURL() }
