...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.vikiclow", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        VikiClowPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        VikiClowPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
