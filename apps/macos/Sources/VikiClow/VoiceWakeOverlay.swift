...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.vikiclow", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other VikiClow windows, but below the system’s pop-up menus.
