...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.vikiclow", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".vikiclow/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.vikiclowCommand(
            subcommand: "gateway",
