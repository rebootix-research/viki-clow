...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.vikiclow", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("VikiClow/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__vikiclow__/a2ui/").absoluteString + "?platform=macos"
    }
