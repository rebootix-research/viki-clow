...
final class AppState {
    ...
    var swabbleTriggerWords: [String] {
        didSet {
            ...
            self.ifNotPreview {
                ...
                self.voiceWakeValidationComplete = false
    ...
    var voiceWakeValidationComplete: Bool {
        didSet {
            self.ifNotPreview { UserDefaults.standard.set(self.voiceWakeValidationComplete, forKey: voiceWakeValidationCompleteKey) }
        }
    }
    ...
    init(preview: Bool = false, treatTestsAsPreview: Bool = true) {
        ...
        self.voiceWakeValidationComplete = UserDefaults.standard
            .object(forKey: voiceWakeValidationCompleteKey) as? Bool ?? false
        ...
        let configRoot = VikiClowConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = VikiClowConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: VikiClowConfigFile.loadDict(),
        ...
        VikiClowConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/vikiclow"
        state.remoteCliPath = ""
        return state
    }
}
