...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .vikiclowSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? VikiClowPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? VikiClowPaths.stateDirURL.path
...
extension Notification.Name {
    static let vikiclowSelectSettingsTab = Notification.Name("vikiclowSelectSettingsTab")
}
