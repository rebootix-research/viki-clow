...
enum VikiClowConfigFile {
    private static let logger = Logger(subsystem: "ai.vikiclow", category: "config")
    ...
    static func stateDirURL() -> URL {
        VikiClowPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        VikiClowPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-vikiclow-config-file",
            "event": "config.write",
