...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.vikiclow", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.vikiclow", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [VikiClowChatMessage] = messages.compactMap { item in
