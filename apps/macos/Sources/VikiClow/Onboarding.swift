...
enum UIStrings {
    static let welcomeTitle = "Welcome to VikiClow"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "vikiclow.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: VikiClowChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g vikiclow@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: VikiClowChatViewModel(
