...
/// Menu contents for the VikiClow menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About VikiClow") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "VikiClow Not Configured"
        case .remote:
            "Remote VikiClow Active"
        case .local:
            "VikiClow Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .vikiclowSelectSettingsTab, object: tab)
        }
    }
