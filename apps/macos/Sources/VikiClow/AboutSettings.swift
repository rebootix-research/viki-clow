...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Text("Copyright 2026 VikiClow. Open source under the MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "VikiClowBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "VikiClowBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "VikiClowGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "VikiClowGitCommit") as? String) ??
            "unknown"
    }
